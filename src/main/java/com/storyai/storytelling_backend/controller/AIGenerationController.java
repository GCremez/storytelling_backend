...
public class AIGenerationController {
  ...
  public AIGenerationController(AIStoryGenerator aiGenerator, AICacheService cacheService) {
  ...
  @Operation(
      summary = "Generate story content using AI",
  ...
  @Operation(
      summary = "Generate story choices options using AI",
    ...
    response.setChoices(
        java.util.List.of(
            new GeneratedChoicesResponse.GeneratedChoice(
                "Continue", "AI service is currently unavailable. Please try again later.")));
    response.setAiProvider("None");
    response.setCached(false);
    return response;
  }
