...
20. [ ] Housekeeping
    ...
    - [x] Fix typos and method naming inconsistencies (PublishStory -> publishStory, UpdateSession -> updateSession)
...
Quick start for Story Content Management (Phase 1)

- Create a story:
  POST /api/v1/stories
  { "title": "My Story", "description": "Intro", "genre": "Fantasy" }

- Add chapters to a story:
  POST /api/v1/stories/{storyId}/chapters
  { "chapterNumber": 1, "title": "Chapter 1", "content": "Once upon a time..." }
...
- Advance to next chapter in a session:
  POST /api/v1/sessions/{sessionId}/next
  Returns 200 with chapter when available, or 204 No Content if completed.
